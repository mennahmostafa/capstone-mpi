...
public  class Log {
	public class Logstream implements Runnable {
		...
		public  Logstream create(BlockingQueue<StringBuilder> queue, String rootPath, int port)
		{
		...
		public  Logstream create(String rootPath, int port)
		{
			return create(new ArrayBlockingQueue<StringBuilder>(10), rootPath, port);
		}

		public  void write(Exception ex, String cls)
		{
			write("Exception: " + ex.toString(), cls);
		}

		public  void write(String msg, String cls)
		{
			_eventLog.write(msg, cls,"");
		}
